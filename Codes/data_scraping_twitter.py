...
# dates = pd.date_range(start = '8/1/2019',end = '12/16/2019', freq = 'H') (original dates)

dates = pd.date_range(start = '12/15/2019', end = '12/16/2019', freq = 'H')
...
x = db.head(1).hashtags[0]

print(f'The code ran smoothly, and the first hashtag in the database is {x}')
